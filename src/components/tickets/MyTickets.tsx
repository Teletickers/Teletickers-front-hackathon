...
export default function MyTickets() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-2">Mis Tickets</h1>
        <p className="text-gray-600">Todos tus boletos en un solo lugar</p>
      </div>
        ...
        <div className="bg-green-50 rounded-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-green-600">{ticketsActivos.length}</p>
            </div>
        ...
        <div className="bg-yellow-50 rounded-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-yellow-600">{ticketsPendientes.length}</p>
            </div>
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-700">{compras.length}</p>
            </div>
            ...
            >
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  ...
                  <h3 className="text-xl font-bold mb-2">Evento #{compra.eventoId.slice(0, 8)}</h3>
